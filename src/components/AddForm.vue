    ...
    <div class="form-container">
      ...
      <div class="flex-container">
        ...
        <div>
          ...
          />
          <br /><br />
          <input v-model="results.email" type="text" id="email" required />
          <br /><br />
        </div>
      </div>
      ...
      <button class="btn btn-sm" @click="clearForm">Clear</button>
      &nbsp;&nbsp;
      <button class="btn btn-sm" @click="submit">Submit</button>
    </div>
  </div>
</template>
